class Dataset:
    def __init__(self, DocumentList, desc="None"):
        ...
        # set of passive attributes not used for trainig. e.g. gold-label, char
        # offsets.
        self.passive = []
        # set of active attributes which require too much memory. So they are
        # only computed in the tagger section.
        self.delayed = []
        self.attr = {}
